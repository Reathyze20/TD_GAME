...
| `doomscroll` | Doomscroll | 40 | 68.0 | 4 | 0 | 5 | 2 | — | L98(w3) |
...
| `notification` | Notification | 5 | 140.0 | 0 | 0 | 1 | 1 | — | L1(w1) L98(w1) |
...
| `anchor` | Anchor | 20 | 0 | 0 | 999.0 | 130.0 | — |
| `exercise` | Exercise | 70 | 34 | 0 | 1.1 | 195.0 | → exercise_2 |
| `exercise_2` | Peak Movement | 80 | 60 | 0 | 0.9 | 230.0 | — |
| `focus_pillar` | Focus Pillar | 70 | 0 | 20 | 4.0 | 150.0 | AoE, stun 1.2s, dispel |
| `focus_timer` | Focus Timer | 30 | 3 | 0 | 0.10 | 180.0 | pomodoro, → focus_timer_2 |
| `focus_timer_2` | Deep Focus | 50 | 5 | 0 | 0.06 | 210.0 | pomodoro |
| `mindfulness` | Mindfulness | 45 | 0 | 5 | 0.7 | 130.0 | AoE, slow 50%, → mindfulness_2 |
| `mindfulness_2` | Deep Mindfulness | 55 | 0 | 10 | 0.55 | 160.0 | AoE, slow 62% |
| `real_hobby` | Deep Reading | 60 | 0 | 2 | 0.15 | 260.0 | DoT 3/s, → real_hobby_2 |
| `real_hobby_2` | Passion Project | 90 | 0 | 3 | 0.12 | 280.0 | DoT 5/s |
| `zen_pulsar` | Zen Pulsar | 70 | 0 | 20 | 4.0 | 150.0 | AoE, stun 1.2s, dispel, → zen_pulsar_2a, zen_pulsar_2b |
| `zen_pulsar_2a` | Resonance Wave | 90 | 0 | 30 | 4.0 | 210.0 | AoE, stun 1.2s, dispel, vuln +25%/3s |
| `zen_pulsar_2b` | Overclocked Stillness | 85 | 0 | 14 | 2.8 | 150.0 | AoE, stun 0.7s, dispel |
