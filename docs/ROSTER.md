...
| `autoplay` | Autoplay | 12 | 110.0 | 0 | 0 | 2 | 1 | — | L1(w1) L2(w2) |
| `clickbait` | Clickbait | 70 | 55.0 | 4 | 2 | 9 | 3 | golem | L1(w1) L2(w4) |
| `doomscroll` | Doomscroll | 40 | 68.0 | 4 | 0 | 5 | 2 | — | L1(w1) L2(w5) |
| `energy_drink` | Energy Drink | 30 | 105.0 | 1 | 0 | 6 | 2 | energiser, overdrive | L1(w1) |
| `group_chat` | Group Chat | 45 | 55.0 | 2 | 1 | 8 | 3 | disruptor | L1(w1) L2(w11) |
| `jackpot` | Jackpot | 55 | 62.0 | 3 | 3 | 14 | 4 | — | L1(w1) |
| `notification` | Notification | 5 | 140.0 | 0 | 0 | 1 | 1 | — | L1(w1) L2(w1) |
| `phantom_buzz` | Phantom Buzz | 8 | 125.0 | 2 | 0 | 3 | 1 | letec | L1(w1) L2(w7) |
| `social_media_binge` | Social Media Binge | 900 | 50.0 | 6 | 4 | 40 | 15 | BOSS | L1(boss) L2(boss) |

## Habity (věže)

| id | jméno | cena | Willpower | Awareness | cooldown | dosah | vlastnosti |
|---|---|---|---|---|---|---|---|
| `accountability` | Accountability | 55 | 0 | 0 | 0.0 | 0.0 | barracks, → accountability_2 |
| `accountability_2` | Support Circle | 85 | 0 | 0 | 0.0 | 0.0 | barracks |
